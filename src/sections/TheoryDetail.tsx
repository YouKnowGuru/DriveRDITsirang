...
export function TheoryDetail() {
  ...
  return (
    <section
      ref={sectionRef}
      id="theory-detail"
      className="relative w-full h-screen bg-off-white dark:bg-near-black overflow-hidden z-30"
    >
      ...
      <div className="relative w-full h-full px-6 lg:px-[9vw] flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
        ...
        <div ref={contentRef} className="w-full lg:w-[34vw]">
          ...
          <p className="animate-item font-body text-base text-text-secondary dark:text-off-white/70 mb-8 leading-relaxed">
            Master the fundamentals: signs, right-of-way, defensive driving, and
            test preparation. Our comprehensive theory course prepares you for
            both the written exam and real-world scenarios.
          </p>
